      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="relative w-72 bg-white h-full p-5 flex flex-col shadow-xl z-50">
            ...
            <Link href="/favorilerim" className="py-2 border-b">Favorilerim</Link>
            <Link href="/sepetim" className="py-2 border-b">Sepetim</Link>

            {token ? (
              <>
                <Link href="/hesabim" className="py-2 border-b">Hesabım</Link>
                <Link href="/siparislerim" className="py-2 border-b">Siparişlerim</Link>
                <button
                  onClick={() => {
                    dispatch(logout());
              ...
              <Link href="/signin" className="py-2 border-b">Giriş Yap</Link>
            )}
          </div>
        </div>
      )}
